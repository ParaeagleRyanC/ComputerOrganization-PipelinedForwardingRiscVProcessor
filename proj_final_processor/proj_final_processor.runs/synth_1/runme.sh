...
HD_PWD='/auto/fsb/ryan9801/ECEN_323/lab11/proj_final_processor/proj_final_processor.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log riscv_final.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source riscv_final.tcl
